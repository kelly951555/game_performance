...
if history_resource is False:
    ...
    for r in result:
        r = r.text.strip()
        sn_path = '#history > div:nth-child({}) > div > table > tbody > tr:nth-child(11) > td:nth-child(1)'.format(r)
        player_path = '#history > div:nth-child({}) > div > table > tbody > tr:nth-child(5) > td'.format(r)
        room_path = '#history > div:nth-child({}) > div > table > tbody > tr:nth-child(9) > td:nth-child(3)'.format(r)
        coin_in_path = '#history > div:nth-child({}) > div > table > tbody ' \
                       '> tr:nth-child(11) > td:nth-child(4)'.format(r)
        coin_out_path = '#history > div:nth-child({}) > div > table > tbody ' \
                        '> tr:nth-child(13) > td:nth-child(3)'.format(r)
        # SN
